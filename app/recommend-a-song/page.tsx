            ...
            <div className="md:col-span-5 space-y-8">
              <motion.div variants={itemVariants}>
                ...
                <p className="text-muted-foreground leading-relaxed font-light">
                  Staylist is a curated sanctuary for sound. We rely on the
                  community to identify high-fidelity signals that deserve a
                  place in our decentralized archive.
                </p>
                <p className="text-muted-foreground leading-relaxed font-light mt-4">
                  Every submission is processed through our verification
                  protocols to ensure atmospheric consistency.
                </p>
              </motion.div>

              <motion.div
                variants={itemVariants}
                className="p-6 border border-white/10 bg-white/2 rounded-sm"
              >
                <h4 className="text-[10px] font-mono text-[#10b981] uppercase tracking-widest mb-4">
                  Transfer Protocols
                </h4>
                <ul className="space-y-3 text-[11px] font-mono text-muted-foreground uppercase tracking-wider">
                  <li className="flex items-start gap-3">
                    <span className="text-[#10b981]">01</span> Verification of
                    source integrity required.
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[#10b981]">02</span> Atmospheric
                    profile must match archive vibe.
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[#10b981]">03</span> Redundant signals
                    will be filtered.
                  </li>
                </ul>
              </motion.div>
