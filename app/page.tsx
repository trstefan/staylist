  ...
  return (
    <>
      ...
      <section className="py-32 relative overflow-hidden group">
         ...
         <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-primary to-transparent opacity-50 shadow-[0_0_20px_rgba(45,212,191,0.5)]"></div>
         ...
         <div className="container mx-auto px-4 text-center relative z-10">
            <h3 className="text-4xl md:text-6xl font-black uppercase tracking-tighter mb-8 transform group-hover:scale-[1.01] transition-transform duration-700">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-white to-accent neon-text">worth archiving?</span>
            </h3>
