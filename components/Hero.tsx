    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          className="absolute w-[500px] h-[500px] bg-white/2 blur-[100px] rounded-full pointer-events-none hidden md:block mix-blend-plus-lighter"
        />
      </motion.div>
      ...
      >
        ...
        <div className="flex flex-col gap-1 text-right">
          <span className="tracking-widest">EST. 2026 | ROMANIA</span>
        </div>
      </motion.div>
      ...
      <div className="container mx-auto px-4 relative z-10 w-full grow flex flex-col justify-center">
        <div className="flex flex-col items-center justify-center relative w-full">
              ...
              {title.split("").map((letter, index) => (
                ...
                >
                  ...
                  <motion.span
                    ...
                    className="absolute inset-0 blur-[25px] text-primary/30 pointer-events-none select-none z-[-1]"
                    aria-hidden="true"
                  >
                    {letter}
                  </motion.span>

                  {/* Sharp Neon Edge Layer */}
                  <span
                    className="absolute inset-0 text-transparent bg-clip-text bg-linear-to-b from-primary/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-1"
                    style={{ WebkitTextStroke: "1px rgba(45, 212, 191, 0.3)" }}
                    aria-hidden="true"
                  >
                    {letter}
                  </span>
          ...
          >
            {/* Decorative lines */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-12 md:w-24 h-px bg-linear-to-r from-transparent via-white/20 to-transparent" />

            <p className="text-sm md:text-xl text-muted-foreground font-light leading-relaxed mt-6 md:mt-8">
              Curating the sound of the{" "}
              <span className="text-white font-normal">decentralized web</span>.{" "}
      ...
      >
        <span className="text-[9px] md:text-[10px] font-mono uppercase tracking-[0.2em] text-muted-foreground/50">
          Scroll
        </span>
        <div className="w-px h-8 md:h-12 bg-linear-to-b from-primary/50 to-transparent overflow-hidden">
          <motion.div
            animate={{ y: [-20, 48] }}
