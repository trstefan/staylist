        ...
        <div className="container mx-auto px-4 md:px-8 h-20 flex items-center justify-between relative z-50">
          <Link href="/" className="flex items-center gap-3 group" onClick={() => setIsOpen(false)}>
            <div className="relative flex items-center justify-center w-10 h-10 rounded-full border border-primary/30 bg-primary/10 text-primary group-hover:bg-primary/20 group-hover:shadow-[0_0_20px_rgba(45,212,191,0.4)] group-hover:border-primary/60 transition-all duration-300">
               <Disc className={`w-5 h-5 ${isOpen ? '' : 'animate-spin-slow'}`} />
            </div>
            <span className="text-xl font-bold tracking-tighter uppercase group-hover:text-primary transition-colors duration-300">Staylist_01</span>
          </Link>
          ...
          <div className="flex items-center gap-4">
            <div className="hidden md:block">
              ...
              <MagneticButton>
                <NeonButton 
                    variant="outline" 
                    className="hidden md:inline-flex h-10 px-6 text-[10px] relative overflow-hidden border-primary/30 text-primary hover:border-primary hover:bg-primary/10 transition-all duration-300 shadow-[0_0_10px_rgba(45,212,191,0.2)] hover:shadow-[0_0_30px_rgba(45,212,191,0.6)] group"
                >
                    ...
                    <div className="absolute inset-0 translate-x-[-150%] group-hover:translate-x-[150%] transition-transform duration-1000 ease-in-out bg-gradient-to-r from-transparent via-white/30 to-transparent skew-x-12 z-0" />
                </NeonButton>
              </MagneticButton>
              </Link>
            </div>
          ...
          >
            ...
            <div className="flex flex-col flex-grow">
              <div className="flex flex-col space-y-2 mt-8">
                <span className="text-[10px] font-mono uppercase text-muted-foreground tracking-widest mb-4 block">Navigation</span>
                <MobileNavLink href="/" index={0} onClick={() => setIsOpen(false)}>Home</MobileNavLink>
                <MobileNavLink href="/catalogue" index={1} onClick={() => setIsOpen(false)}>Catalogue</MobileNavLink>
                <MobileNavLink href="/about-staylist" index={2} onClick={() => setIsOpen(false)}>About</MobileNavLink>
              </div>
              ...
              <div className="mt-auto pt-12">
                 ...
                 <Link href="/recommend-a-song">
                  ...
                  >
                      <span className="flex items-center gap-2">
                          <span className="uppercase tracking-wider text-xs text-center">Recommend a Song</span>
                      </span>
                  </NeonButton>
                  </Link>
                </motion.div>
                ...
                >
                    <span className="text-[10px] uppercase text-muted-foreground">© 2025 Staylist</span>
                    <div className="flex gap-4">
                        <a href="#" className="text-[10px] uppercase text-muted-foreground hover:text-white">TW</a>
                        <a href="#" className="text-[10px] uppercase text-muted-foreground hover:text-white">IG</a>
                        <a href="#" className="text-[10px] uppercase text-muted-foreground hover:text-white">DC</a>
                    </div>
                </motion.div>
              </div>
            </div>
